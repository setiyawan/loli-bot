<body>
    ...
    <div id="wrapper">
        ...
        <!-- /#page-wrapper -->
                            ...
                            <?php if($tab) { $aktif = "class='active'";?>
                                <ul class="nav nav-tabs">
                                    <?php foreach ($tab as $key) { ?>
                                        <li <?=$aktif ?> ><a href="#<?=$key['key'] ?>" data-toggle="tab"><?=$key['label'] ?></a> </li>
                                    <?php $aktif = ''; } ?>
                                </ul>
                            <?php } ?>
                                <div class="tab-content">
                                <?php  $indek = 0; $i_up = 0; $i_down = 0; $i_u_before = 0; $i_before = -1; 
                                ...
                                <?php if(!empty($tab)) { ?>
                                    <?php if($indek == 0) { ?>
                                        <div class="tab-pane fade in active" id="<?=$tab[$i_up]['key'] ?>">
                                            <table class="table table-striped table-bordered" cellspacing="0">                     
                                    <?php 
                                        $i_u_before = $tab[$i_up]['row']; $i_up++; } 
                                        else if($indek == $i_u_before) { ?>
                                        <div class="tab-pane fade" id="<?=$tab[$i_up]['key'] ?>">
                                            <table class="table table-striped table-bordered" cellspacing="0">
            ...
            <?php } if(!empty($c_edit)) { ?>
            <form id="formUpdate" class="modal fade" action="update" method="post" class="form" style="display: none; align:center">
            <div class="modal-dialog modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button class="close" aria-hidden="true" data-dismiss="modal" type="button">×</button>
